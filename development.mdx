---
title: 'Development'
description: 'Preview documentation changes locally using the Mintlify CLI before publishing. Install the CLI, run mint dev, and see live updates in your browser.'
---
